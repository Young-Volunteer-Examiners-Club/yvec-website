...
export default function Home() {
  return (
    <main className="website-shell">
      ...
      <p className="info">
        <br /> • "Membership may not be denied or terminated because of race, creed, color, religion, gender, sexual orientation, political affiliation, marital status, disability or any other reason that would be biased or prejudicial." - YVEC Constitution and Bylaws
        <br /><br /> • We proudly support people of the LGBTQIA+ community, people of color, members of any and all religions, the disabled, and people apart of marginalized groups!
        <br /><br /> • All are welcome. If you think otherwise, you aren't! Bigotry is not allowed and will result in immediate termination! This includes but is not limited to: Racism, Homophobia, Transphobia, Xenophobia, and Classism.
      </p>
